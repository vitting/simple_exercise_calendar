class DbSql {
  ...
  static const String createEvents = "CREATE TABLE IF NOT EXISTS [$tableEvents] ([$colId] TEXT(50) PRIMARY KEY NOT NULL UNIQUE, [$colExercisePlanId] TEXT(50) NOT NULL, [$colTemplateExercisePlanId] TEXT(50) NOT NULL, [$colDate] INTEGER NOT NULL);";
